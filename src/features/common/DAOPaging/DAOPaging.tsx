...
const DAOPaging: FC<PaginationProps> = ({
  current,
  maxPage,
  itemsPerPage,
  onPageChange,
        ...
        <ul className="inline-flex items-center space-x-1 rounded-lg text-sm">
          <li className="inline-flex items-center space-x-1">
            <button
              ...
              className={`inline-flex items-center space-x-2 rounded-lg px-4 border ${
                current === 1
                  ? "border-gray-300 text-gray-300 cursor-not-allowed"
                  : "border-gray-300 text-red-600"
              } bg-gray-50 px-2 py-2 font-medium hover:bg-gray-100`}
              disabled={current === 1}
            >
              First
            </button>
          ...
          <li>
            <span className="inline-flex items-center space-x-1 rounded-md bg-gray-50 hover:bg-gray-100 border border-gray-300 px-4 py-2 text-gray-500">
              Page
